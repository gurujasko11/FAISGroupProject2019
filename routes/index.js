...
router.get('/edit_match', function (req, res, next) {
    res.render('edit_match', {match: {name: "AS Monaco - Atletico Madryt"}, page: 'main', title: 'Edycja meczu'});
});

router.get('/add_match', function (req, res, next) {
    res.render('add_match', {page: 'main', title: 'Edycja meczu'});
});
